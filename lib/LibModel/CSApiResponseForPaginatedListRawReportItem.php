 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CSApiResponseForPaginatedListRawReportItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApiResponseForPaginated[List[RawReportItem]]';
    ...
    protected static $swaggerTypes = [
        'totalSetCount' => 'int',
        'data' => '\ChronoSheetsClient\ChronoSheetsClientLibModel\CSRawReportItem[]',
        'status' => 'string',
        'message' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \ChronoSheetsClient\ChronoSheetsClientLibModel\CSRawReportItem[]
     */
