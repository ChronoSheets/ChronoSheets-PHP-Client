...
/**
 * CSAggregateClient Class Doc Comment
 *
 * @category Class
 * @package  ChronoSheetsClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CSAggregateClient implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AggregateClient';
    ...
    protected static $swaggerTypes = [
        'clientProjects' => '\ChronoSheetsClient\ChronoSheetsClientLibModel\CSAggregateProject[]',
        'id' => 'int',
        'organisationId' => 'int',
        'clientName' => 'string',
     ...
     * Gets clientProjects
     *
     * @return \ChronoSheetsClient\ChronoSheetsClientLibModel\CSAggregateProject[]
     */
