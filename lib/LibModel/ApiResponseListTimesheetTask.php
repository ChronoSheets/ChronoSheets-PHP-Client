...
/**
 * ApiResponseListTimesheetTask Class Doc Comment
 *
 * @category Class
 ...
 */
class ApiResponseListTimesheetTask implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiResponse[List[TimesheetTask]]';
    ...
    protected static $openAPITypes = [
        'data' => '\ChronoSheetsClient\ChronoSheetsClientLibModel\TimesheetTask[]',
        'status' => 'string',
        'message' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \ChronoSheetsClient\ChronoSheetsClientLibModel\TimesheetTask[]|null
     */
     ...
     * Sets data
     *
     * @param \ChronoSheetsClient\ChronoSheetsClientLibModel\TimesheetTask[]|null $data The main Data of the response
     *
     * @return self
     */
