 ...
 */
class OrgReportTranscript implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['finishedJob'] = $data['finishedJob'] ?? null;
        $this->container['completedProcessing'] = $data['completedProcessing'] ?? null;
        $this->container['created'] = $data['created'] ?? null;
        $this->container['startedProcessing'] = $data['startedProcessing'] ?? null;
        $this->container['transcriptionId'] = $data['transcriptionId'] ?? null;
        ...
        $this->container['transcriptionStatus'] = $data['transcriptionStatus'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['transcriptionStatus']) && !in_array($this->container['transcriptionStatus'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'transcriptionStatus', must be one of '%s'",
                $this->container['transcriptionStatus'],
                implode("', '", $allowedValues)
            );
        }
