...
/**
 * OrgReportTranscript Class Doc Comment
 *
 * @category Class
 * @package  ChronoSheetsClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class OrgReportTranscript implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrgReportTranscript';
    ...
    const TRANSCRIPTION_STATUS_SAVED = 'Saved';
    const TRANSCRIPTION_STATUS_PROCESSING = 'Processing';
    const TRANSCRIPTION_STATUS_COMPLETED = 'Completed';
    const TRANSCRIPTION_STATUS_FAILED_WITH_ERROR = 'FailedWithError';
    ...
    {
        return [
            self::TRANSCRIPTION_STATUS_SAVED,
            self::TRANSCRIPTION_STATUS_PROCESSING,
            self::TRANSCRIPTION_STATUS_COMPLETED,
            self::TRANSCRIPTION_STATUS_FAILED_WITH_ERROR,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['transcriptionStatus']) && !in_array($this->container['transcriptionStatus'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
     ...
     * Sets finishedJob
     *
     * @param bool|null $finishedJob finishedJob
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime|null $completedProcessing completedProcessing
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime|null $startedProcessing startedProcessing
     *
     * @return $this
     */
     ...
     *
     * @param int|null $transcriptionId transcriptionId
     *
     * @return $this
     */
     ...
     * Sets jobName
     *
     * @param string|null $jobName jobName
     *
     * @return $this
     */
     ...
     *
     * @param string|null $transcriptionStatus transcriptionStatus
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getTranscriptionStatusAllowableValues();
        if (!is_null($transcriptionStatus) && !in_array($transcriptionStatus, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'transcriptionStatus', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     *
     * @param string|null $documentS3SignedUrl documentS3SignedUrl
     *
     * @return $this
     */
     ...
     *
     * @param string|null $imageLargeS3SignedUrl imageLargeS3SignedUrl
     *
     * @return $this
     */
     ...
     *
     * @param string|null $imageMediumS3SignedUrl imageMediumS3SignedUrl
     *
     * @return $this
     */
     ...
     *
     * @param string|null $imageSmallS3SignedUrl imageSmallS3SignedUrl
     *
     * @return $this
     */
     ...
     * Sets timesheetStart
     *
     * @param \DateTime|null $timesheetStart timesheetStart
     *
     * @return $this
     */
     ...
     * Sets timesheetEnd
     *
     * @param \DateTime|null $timesheetEnd timesheetEnd
     *
     * @return $this
     */
     ...
     *
     * @param string|null $nonImageFilePath nonImageFilePath
     *
     * @return $this
     */
     ...
     *
     * @param string|null $imageLargeFilePath imageLargeFilePath
     *
     * @return $this
     */
     ...
     *
     * @param string|null $imageMediumFilePath imageMediumFilePath
     *
     * @return $this
     */
     ...
     *
     * @param string|null $imageSmallFilePath imageSmallFilePath
     *
     * @return $this
     */
     ...
     * Sets dateUploaded
     *
     * @param \DateTime|null $dateUploaded dateUploaded
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime|null $dateImageCaptured dateImageCaptured
     *
     * @return $this
     */
     ...
     *
     * @param int|null $storageAllocationBytes storageAllocationBytes
     *
     * @return $this
     */
     ...
     *
     * @param int|null $audioDurationSeconds audioDurationSeconds
     *
     * @return $this
     */
