...
/**
 * ApiResponseForPaginatedListTrip Class Doc Comment
 *
 * @category Class
 ...
 */
class ApiResponseForPaginatedListTrip implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiResponseForPaginated[List[Trip]]';
    ...
    protected static $openAPITypes = [
        'totalSetCount' => 'int',
        'data' => '\ChronoSheetsClient\ChronoSheetsClientLibModel\Trip[]',
        'status' => 'string',
        'message' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \ChronoSheetsClient\ChronoSheetsClientLibModel\Trip[]|null
     */
     ...
     * Sets data
     *
     * @param \ChronoSheetsClient\ChronoSheetsClientLibModel\Trip[]|null $data The main Data of the response
     *
     * @return self
     */
