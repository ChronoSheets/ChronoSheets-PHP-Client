...
/**
 * CSApiResponseListJobSeriesReportItem Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CSApiResponseListJobSeriesReportItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApiResponse[List[JobSeriesReportItem]]';
    ...
    protected static $swaggerTypes = [
        'data' => '\ChronoSheetsClient\ChronoSheetsClientLibModel\CSJobSeriesReportItem[]',
        'status' => 'string',
        'message' => 'string'
    ];
     ...
     * Sets data
     *
     * @param \ChronoSheetsClient\ChronoSheetsClientLibModel\CSJobSeriesReportItem[] $data The main Data of the response
     *
     * @return $this
     */
