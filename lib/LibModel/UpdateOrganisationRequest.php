 ...
 */
class UpdateOrganisationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['organsationId'] = $data['organsationId'] ?? null;
        $this->container['organisationName'] = $data['organisationName'] ?? null;
        $this->container['addressLine01'] = $data['addressLine01'] ?? null;
        $this->container['addressLine02'] = $data['addressLine02'] ?? null;
        $this->container['organisationSuburb'] = $data['organisationSuburb'] ?? null;
        $this->container['organisationState'] = $data['organisationState'] ?? null;
        $this->container['organisationPostcode'] = $data['organisationPostcode'] ?? null;
        $this->container['organisationCountry'] = $data['organisationCountry'] ?? null;
        $this->container['organisationPhone'] = $data['organisationPhone'] ?? null;
        $this->container['organisationEmailAddress'] = $data['organisationEmailAddress'] ?? null;
    }
