...
/**
 * CSApiResponseForPaginatedListTrip Class Doc Comment
 *
 * @category Class
 * @package  ChronoSheetsClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CSApiResponseForPaginatedListTrip implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApiResponseForPaginated[List[Trip]]';
    ...
    protected static $swaggerTypes = [
        'totalSetCount' => 'int',
        'data' => '\ChronoSheetsClient\ChronoSheetsClientLibModel\CSTrip[]',
        'status' => 'string',
        'message' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \ChronoSheetsClient\ChronoSheetsClientLibModel\CSTrip[]
     */
