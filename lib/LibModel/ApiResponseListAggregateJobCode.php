...
/**
 * ApiResponseListAggregateJobCode Class Doc Comment
 *
 * @category Class
 ...
 */
class ApiResponseListAggregateJobCode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiResponse[List[AggregateJobCode]]';
    ...
    protected static $openAPITypes = [
        'data' => '\ChronoSheetsClient\ChronoSheetsClientLibModel\AggregateJobCode[]',
        'status' => 'string',
        'message' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \ChronoSheetsClient\ChronoSheetsClientLibModel\AggregateJobCode[]|null
     */
     ...
     * Sets data
     *
     * @param \ChronoSheetsClient\ChronoSheetsClientLibModel\AggregateJobCode[]|null $data The main Data of the response
     *
     * @return self
     */
