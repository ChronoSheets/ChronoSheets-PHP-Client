...
/**
 * CSApiResponseListUsualHoursDay Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CSApiResponseListUsualHoursDay implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApiResponse[List[UsualHoursDay]]';
    ...
    protected static $swaggerTypes = [
        'data' => '\ChronoSheetsClient\ChronoSheetsClientLibModel\CSUsualHoursDay[]',
        'status' => 'string',
        'message' => 'string'
    ];
     ...
     * Sets data
     *
     * @param \ChronoSheetsClient\ChronoSheetsClientLibModel\CSUsualHoursDay[] $data The main Data of the response
     *
     * @return $this
     */
