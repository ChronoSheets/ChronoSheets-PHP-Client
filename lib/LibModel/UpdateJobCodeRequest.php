...
/**
 * UpdateJobCodeRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateJobCodeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateJobCodeRequest';
     ...
     * Sets id
     *
     * @param int|null $id The Id of the JobCode to be updated
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param string|null $code The new JobCode to be set
     *
     * @return self
     */
     ...
     * Sets projectId
     *
     * @param int|null $projectId The Id of the Project to be associated to
     *
     * @return self
     */
     ...
     * Sets clientId
     *
     * @param int|null $clientId The Id of the Client to be associated to
     *
     * @return self
     */
     ...
     * Sets linkedTaskIds
     *
     * @param int[]|null $linkedTaskIds A collection of Task Ids to be available when choosing this JobCode
     *
     * @return self
     */
     ...
     *
     * @param int[]|null $linkedOrgGroupIds Restrict the access to this JobCode by specifying which Organisation Groups can have access.  Only employees in these Organisation Groups will be able to access this JobCode
     *
     * @return self
     */
     ...
     * Sets isDeleted
     *
     * @param bool|null $isDeleted Whether or not this JobCode is to be marked as deleted
     *
     * @return self
     */
