...
/**
 * ApiResponseListAggregateClient Class Doc Comment
 *
 * @category Class
 ...
 */
class ApiResponseListAggregateClient implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiResponse[List[AggregateClient]]';
    ...
    protected static $openAPITypes = [
        'data' => '\ChronoSheetsClient\ChronoSheetsClientLibModel\AggregateClient[]',
        'status' => 'string',
        'message' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \ChronoSheetsClient\ChronoSheetsClientLibModel\AggregateClient[]|null
     */
     ...
     * Sets data
     *
     * @param \ChronoSheetsClient\ChronoSheetsClientLibModel\AggregateClient[]|null $data The main Data of the response
     *
     * @return self
     */
