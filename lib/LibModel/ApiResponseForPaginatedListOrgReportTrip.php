...
/**
 * ApiResponseForPaginatedListOrgReportTrip Class Doc Comment
 *
 * @category Class
 ...
 */
class ApiResponseForPaginatedListOrgReportTrip implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiResponseForPaginated[List[OrgReportTrip]]';
    ...
    protected static $openAPITypes = [
        'totalSetCount' => 'int',
        'data' => '\ChronoSheetsClient\ChronoSheetsClientLibModel\OrgReportTrip[]',
        'status' => 'string',
        'message' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \ChronoSheetsClient\ChronoSheetsClientLibModel\OrgReportTrip[]|null
     */
     ...
     * Sets data
     *
     * @param \ChronoSheetsClient\ChronoSheetsClientLibModel\OrgReportTrip[]|null $data The main Data of the response
     *
     * @return self
     */
