 ...
 */
class ExtendedGeofence implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['jobCode'] = $data['jobCode'] ?? null;
        $this->container['taskName'] = $data['taskName'] ?? null;
        $this->container['createdBy'] = $data['createdBy'] ?? null;
        $this->container['updatedBy'] = $data['updatedBy'] ?? null;
        $this->container['alertOrganisation'] = $data['alertOrganisation'] ?? null;
     ...
     * Sets jobCode
     *
     * @param string|null $jobCode The Job code used when the employee enters/exits the geofence
     *
     * @return self
     */
     ...
     * Sets taskName
     *
     * @param string|null $taskName The name of the task used when the employee enters/exits the geofence
     *
     * @return self
     */
     ...
     * Sets createdBy
     *
     * @param string|null $createdBy The name of the employee who created the geofence
     *
     * @return self
     */
     ...
     * Sets updatedBy
     *
     * @param string|null $updatedBy The name of the employee who last updated the geofence
     *
     * @return self
     */
     ...
     *
     * @param string|null $alertOrganisation The name of the organisation group who will be notified when the geofence is triggered
     *
     * @return self
     */
