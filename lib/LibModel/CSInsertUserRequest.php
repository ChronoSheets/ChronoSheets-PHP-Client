...
class CSInsertUserRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets userName
     *
     * @param string $userName The UserName of the employee.  This can be used when logging into ChronoSheets
     *
     * @return $this
     */
     ...
     * Sets hourlyPayRate
     *
     * @param double $hourlyPayRate Set the starting usual Hourly Pay Rate with this value.  This is the Pay Rate the employee receives for working during Rostered Hours
     *
     * @return $this
     */
     ...
     *
     * @param double $hourlyOvertimePayRate Set the starting usual Overtime Hourly Pay Rate with this value.  This is the Pay Rate the employee receives for working outside of Rostered Hours
     *
     * @return $this
     */
