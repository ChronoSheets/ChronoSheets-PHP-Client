...
/**
 * SaveOrganisationGroupRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class SaveOrganisationGroupRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SaveOrganisationGroupRequest';
     ...
     * Sets id
     *
     * @param int|null $id The Id of the Organisation Group you want to update/save
     *
     * @return self
     */
     ...
     *
     * @param string|null $organisationGroupName The updated name of the Organisation Group
     *
     * @return self
     */
     ...
     * Sets isDeleted
     *
     * @param bool|null $isDeleted Whether or not the Organisation Group is to be marked as deleted
     *
     * @return self
     */
