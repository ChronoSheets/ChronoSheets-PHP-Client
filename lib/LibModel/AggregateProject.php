...
/**
 * AggregateProject Class Doc Comment
 *
 * @category Class
 * @package  ChronoSheetsClient
 * @author   OpenAPI Generator team
 ...
 */
class AggregateProject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AggregateProject';
     ...
     * Sets clientId
     *
     * @param int|null $clientId The ID of the client that this project is assigned to
     *
     * @return self
     */
     ...
     * Sets projectName
     *
     * @param string|null $projectName The name of the project (can be viewed in PROJECT TIMELINES)
     *
     * @return self
     */
     ...
     * Sets costEstimation
     *
     * @param double|null $costEstimation The estimated cost of the project (can be viewed in PROJECT TIMELINES)
     *
     * @return self
     */
     ...
     * Sets startDate
     *
     * @param \DateTime|null $startDate The start date of the project (can be viewed in PROJECT TIMELINES)
     *
     * @return self
     */
     ...
     * Sets endDate
     *
     * @param \DateTime|null $endDate The end date of the project (can be viewed in PROJECT TIMELINES)
     *
     * @return self
     */
