...
/**
 * CSApiResponseOrganisation Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CSApiResponseOrganisation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApiResponse[Organisation]';
    ...
    protected static $swaggerTypes = [
        'data' => '\ChronoSheetsClient\ChronoSheetsClientLibModel\CSOrganisation',
        'status' => 'string',
        'message' => 'string'
    ];
     ...
     * Sets data
     *
     * @param \ChronoSheetsClient\ChronoSheetsClientLibModel\CSOrganisation $data The main Data of the response
     *
     * @return $this
     */
