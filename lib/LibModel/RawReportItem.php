 ...
 */
class RawReportItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['payOvertimeAmount'] = $data['payOvertimeAmount'] ?? null;
        $this->container['tripCost'] = $data['tripCost'] ?? null;
        $this->container['tripDistanceMeters'] = $data['tripDistanceMeters'] ?? null;
        $this->container['spanSecondsNormalTime'] = $data['spanSecondsNormalTime'] ?? null;
        $this->container['spanSecondsOvertime'] = $data['spanSecondsOvertime'] ?? null;
    }
