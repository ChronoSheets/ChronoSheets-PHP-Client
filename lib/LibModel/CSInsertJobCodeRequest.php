...
/**
 * CSInsertJobCodeRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CSInsertJobCodeRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InsertJobCodeRequest';
     ...
     * Sets code
     *
     * @param string $code A short code for the Job.  This is referred to as a Job Code
     *
     * @return $this
     */
     ...
     * Sets projectId
     *
     * @param int $projectId The linked Project.  Time spent with this JobCode is on this Project
     *
     * @return $this
     */
     ...
     * Sets clientId
     *
     * @param int $clientId The linked Client.  Time spent with this JobCode is for this Client
     *
     * @return $this
     */
     ...
     * Sets linkedTaskIds
     *
     * @param int[] $linkedTaskIds A list of Task Ids.  This are the Tasks that become available to the employee when they select this JobCode
     *
     * @return $this
     */
     ...
     *
     * @param int[] $linkedOrgGroupIds Optionally restrict access to the JobCode by specifying which Organisation Groups can use it
     *
     * @return $this
     */
