...
class Organisation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['addressLine01'] = $data['addressLine01'] ?? null;
        $this->container['addressLine02'] = $data['addressLine02'] ?? null;
        ...
        $this->container['subscriptionCustomerId'] = $data['subscriptionCustomerId'] ?? null;
        $this->container['signupToken'] = $data['signupToken'] ?? null;
        $this->container['isActive'] = $data['isActive'] ?? null;
        $this->container['stripeCouponCode'] = $data['stripeCouponCode'] ?? null;
        $this->container['subscriptionSource'] = $data['subscriptionSource'] ?? null;
        $this->container['signUpSource'] = $data['signUpSource'] ?? null;
        $this->container['mobileSignUpCode'] = $data['mobileSignUpCode'] ?? null;
        $this->container['subscriptionCycleStart'] = $data['subscriptionCycleStart'] ?? null;
        $this->container['subscriptionCycleEnd'] = $data['subscriptionCycleEnd'] ?? null;
        $this->container['pricingPlans'] = $data['pricingPlans'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['subscriptionSource']) && !in_array($this->container['subscriptionSource'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'subscriptionSource', must be one of '%s'",
                $this->container['subscriptionSource'],
        ...
        if (!is_null($this->container['signUpSource']) && !in_array($this->container['signUpSource'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'signUpSource', must be one of '%s'",
                $this->container['signUpSource'],
                implode("', '", $allowedValues)
            );
        }
     ...
     * Sets id
     *
     * @param int|null $id The ID of the organisation
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the organisation
     *
     * @return self
     */
     ...
     * Sets addressLine01
     *
     * @param string|null $addressLine01 Address line 1 of the organisation
     *
     * @return self
     */
     ...
     * Sets addressLine02
     *
     * @param string|null $addressLine02 Address line 2 of the organisation
     *
     * @return self
     */
     ...
     * Sets suburb
     *
     * @param string|null $suburb The suburb where the organisation is located
     *
     * @return self
     */
     ...
     * Sets state
     *
     * @param string|null $state The state where the organisation is located
     *
     * @return self
     */
     ...
     * Sets postcode
     *
     * @param string|null $postcode The postcode of the organisation
     *
     * @return self
     */
     ...
     * Sets country
     *
     * @param string|null $country The country of the organisation
     *
     * @return self
     */
     ...
     * Sets phone
     *
     * @param string|null $phone The primary phone contact number of the organisation
     *
     * @return self
     */
     ...
     * Sets emailAddress
     *
     * @param string|null $emailAddress The primary email address of the organisation
     *
     * @return self
     */
     ...
     * Sets timezone
     *
     * @param string|null $timezone The timezone of the organisation
     *
     * @return self
     */
     ...
     *
     * @param string|null $subscriptionCustomerId The customer ID of the payments subscription
     *
     * @return self
     */
     ...
     * Sets signupToken
     *
     * @param string|null $signupToken The sign up token
     *
     * @return self
     */
     ...
     * Sets isActive
     *
     * @param bool|null $isActive Whether or not the organisation is active
     *
     * @return self
     */
     ...
     *
     * @param string|null $stripeCouponCode The payments coupon code
     *
     * @return self
     */
     ...
     *
     * @param string|null $subscriptionSource The source of the subscription
     *
     * @return self
     */
     ...
     * Sets signUpSource
     *
     * @param string|null $signUpSource The source where the organisation signed up
     *
     * @return self
     */
     ...
     *
     * @param string|null $mobileSignUpCode A temporary mobile sign up code
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $subscriptionCycleStart The start date and time of the organisations subscription
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $subscriptionCycleEnd The end date and time of the organisations subscription
     *
     * @return self
     */
     ...
     * Sets pricingPlans
     *
     * @param \ChronoSheetsClient\ChronoSheetsClientLibModel\OrganisationPricingPlan[]|null $pricingPlans The organisation's pricing plans
     *
     * @return self
     */
