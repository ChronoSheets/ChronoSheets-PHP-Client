...
/**
 * ApiResponseListJobSeriesReportItem Class Doc Comment
 *
 * @category Class
 ...
 */
class ApiResponseListJobSeriesReportItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiResponse[List[JobSeriesReportItem]]';
    ...
    protected static $openAPITypes = [
        'data' => '\ChronoSheetsClient\ChronoSheetsClientLibModel\JobSeriesReportItem[]',
        'status' => 'string',
        'message' => 'string'
    ];
     ...
     * Sets data
     *
     * @param \ChronoSheetsClient\ChronoSheetsClientLibModel\JobSeriesReportItem[]|null $data The main Data of the response
     *
     * @return self
     */
