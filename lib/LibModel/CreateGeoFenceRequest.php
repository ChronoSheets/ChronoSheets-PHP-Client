...
/**
 * CreateGeoFenceRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateGeoFenceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateGeoFenceRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['fenceCoordinates'] = $data['fenceCoordinates'] ?? null;
        $this->container['triggerJobCodeId'] = $data['triggerJobCodeId'] ?? null;
        $this->container['triggerTaskId'] = $data['triggerTaskId'] ?? null;
        $this->container['sendAlertToOrgGroupId'] = $data['sendAlertToOrgGroupId'] ?? null;
     ...
     * Sets alertSettings
     *
     * @param string|null $alertSettings Define when you want the alerts to be sent
     *
     * @return self
     */
