...
/**
 * ApiResponseListTimesheet Class Doc Comment
 *
 * @category Class
 ...
 */
class ApiResponseListTimesheet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiResponse[List[Timesheet]]';
    ...
    protected static $openAPITypes = [
        'data' => '\ChronoSheetsClient\ChronoSheetsClientLibModel\Timesheet[]',
        'status' => 'string',
        'message' => 'string'
    ];
     ...
     * Sets data
     *
     * @param \ChronoSheetsClient\ChronoSheetsClientLibModel\Timesheet[]|null $data The main Data of the response
     *
     * @return self
     */
