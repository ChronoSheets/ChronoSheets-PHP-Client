...
/**
 * CSSaveOrganisationGroupRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CSSaveOrganisationGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SaveOrganisationGroupRequest';
     ...
     * Sets id
     *
     * @param int $id The Id of the Organisation Group you want to update/save
     *
     * @return $this
     */
     ...
     *
     * @param string $organisationGroupName The updated name of the Organisation Group
     *
     * @return $this
     */
     ...
     * Sets isDeleted
     *
     * @param bool $isDeleted Whether or not the Organisation Group is to be marked as deleted
     *
     * @return $this
     */
