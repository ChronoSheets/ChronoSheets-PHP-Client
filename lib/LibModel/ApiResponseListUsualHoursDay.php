...
/**
 * ApiResponseListUsualHoursDay Class Doc Comment
 *
 * @category Class
 ...
 */
class ApiResponseListUsualHoursDay implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiResponse[List[UsualHoursDay]]';
    ...
    protected static $openAPITypes = [
        'data' => '\ChronoSheetsClient\ChronoSheetsClientLibModel\UsualHoursDay[]',
        'status' => 'string',
        'message' => 'string'
    ];
     ...
     * Sets data
     *
     * @param \ChronoSheetsClient\ChronoSheetsClientLibModel\UsualHoursDay[]|null $data The main Data of the response
     *
     * @return self
     */
