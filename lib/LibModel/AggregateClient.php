...
/**
 * AggregateClient Class Doc Comment
 *
 * @category Class
 * @package  ChronoSheetsClient
 * @author   OpenAPI Generator team
 ...
 */
class AggregateClient implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AggregateClient';
    ...
    protected static $openAPITypes = [
        'clientProjects' => '\ChronoSheetsClient\ChronoSheetsClientLibModel\AggregateProject[]',
        'id' => 'int',
        'organisationId' => 'int',
        'clientName' => 'string',
    ...
    protected static $setters = [
        'clientProjects' => 'setClientProjects',
        'id' => 'setId',
    ...
    protected static $getters = [
        'clientProjects' => 'getClientProjects',
        'id' => 'getId',
    ...
    {
        $this->container['clientProjects'] = $data['clientProjects'] ?? null;
        ...
        $this->container['projectCount'] = $data['projectCount'] ?? null;
    }
     ...
     * Gets clientProjects
     *
     * @return \ChronoSheetsClient\ChronoSheetsClientLibModel\AggregateProject[]|null
     */
    public function getClientProjects()
    {
        return $this->container['clientProjects'];
    }

    /**
     * Sets clientProjects
     *
     * @param \ChronoSheetsClient\ChronoSheetsClientLibModel\AggregateProject[]|null $clientProjects A list of projects that are under this client
     *
     * @return self
     */
    public function setClientProjects($clientProjects)
    {
        $this->container['clientProjects'] = $clientProjects;
     ...
     * Sets organisationId
     *
     * @param int|null $organisationId The ID of your organisation
     *
     * @return self
     */
     ...
     *
     * @param string|null $clientAddressLine1 The address line 1 of the client
     *
     * @return self
     */
     ...
     *
     * @param string|null $clientAddressLine2 The address line 2 of the client
     *
     * @return self
     */
     ...
     * Sets clientSuburb
     *
     * @param string|null $clientSuburb The address suburb of the client
     *
     * @return self
     */
     ...
     * Sets clientState
     *
     * @param string|null $clientState The address state of the client
     *
     * @return self
     */
     ...
     * Sets clientPostCode
     *
     * @param string|null $clientPostCode The postcode of the client
     *
     * @return self
     */
     ...
     *
     * @param string|null $personOfContact The contact person working under the client
     *
     * @return self
     */
     ...
     * Sets clientWebURL
     *
     * @param string|null $clientWebURL The website URL of the client
     *
     * @return self
     */
     ...
     * Sets projectCount
     *
     * @param int|null $projectCount The number of projects under the client
     *
     * @return self
     */
