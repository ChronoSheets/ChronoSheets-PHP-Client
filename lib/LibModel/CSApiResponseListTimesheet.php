...
/**
 * CSApiResponseListTimesheet Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CSApiResponseListTimesheet implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApiResponse[List[Timesheet]]';
    ...
    protected static $swaggerTypes = [
        'data' => '\ChronoSheetsClient\ChronoSheetsClientLibModel\CSTimesheet[]',
        'status' => 'string',
        'message' => 'string'
    ];
     ...
     * Sets data
     *
     * @param \ChronoSheetsClient\ChronoSheetsClientLibModel\CSTimesheet[] $data The main Data of the response
     *
     * @return $this
     */
