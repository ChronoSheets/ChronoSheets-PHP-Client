...
/**
 * CSInsertOrganisationGroupRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CSInsertOrganisationGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InsertOrganisationGroupRequest';
     ...
     *
     * @param string $organisationGroupName The name of the new Organisation Group.  This is used when you're looking up Organisation Groups elsewhere through ChronoSheets
     *
     * @return $this
     */
     ...
     *
     * @param int[] $organisationGroupUserIds The Ids of the Users that are going to be in this Organisation Group
     *
     * @return $this
     */
