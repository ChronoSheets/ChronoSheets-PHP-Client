 ...
 */
class DoLoginRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['usernameOrEmail'] = $data['usernameOrEmail'] ?? null;
        $this->container['password'] = $data['password'] ?? null;
        $this->container['rememberMe'] = $data['rememberMe'] ?? null;
    }
