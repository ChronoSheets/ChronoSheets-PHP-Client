...
/**
 * CSApiResponseForPaginatedListOrgReportTimesheetFileAttachment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CSApiResponseForPaginatedListOrgReportTimesheetFileAttachment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApiResponseForPaginated[List[OrgReportTimesheetFileAttachment]]';
    ...
    protected static $swaggerTypes = [
        'totalSetCount' => 'int',
        'data' => '\ChronoSheetsClient\ChronoSheetsClientLibModel\CSOrgReportTimesheetFileAttachment[]',
        'status' => 'string',
        'message' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \ChronoSheetsClient\ChronoSheetsClientLibModel\CSOrgReportTimesheetFileAttachment[]
     */
     ...
     * Sets data
     *
     * @param \ChronoSheetsClient\ChronoSheetsClientLibModel\CSOrgReportTimesheetFileAttachment[] $data The main Data of the response
     *
     * @return $this
     */
