...
/**
 * ApiResponseForPaginatedListExtendedGeofence Class Doc Comment
 *
 * @category Class
 ...
 */
class ApiResponseForPaginatedListExtendedGeofence implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiResponseForPaginated[List[ExtendedGeofence]]';
    ...
    protected static $openAPITypes = [
        'totalSetCount' => 'int',
        'data' => '\ChronoSheetsClient\ChronoSheetsClientLibModel\ExtendedGeofence[]',
        'status' => 'string',
        'message' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \ChronoSheetsClient\ChronoSheetsClientLibModel\ExtendedGeofence[]|null
     */
     ...
     * Sets data
     *
     * @param \ChronoSheetsClient\ChronoSheetsClientLibModel\ExtendedGeofence[]|null $data The main Data of the response
     *
     * @return self
     */
