...
class TimesheetsApi
{
     ...
     */
    public function timesheetsCreateSingleTimesheetRequest($xChronosheetsAuth, $request)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function timesheetsDeleteTimesheetRequest($timesheetId, $xChronosheetsAuth)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function timesheetsGetTimesheetsRequest($startDate, $endDate, $xChronosheetsAuth)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function timesheetsUpdateTimesheetsRequest($xChronosheetsAuth, $request)
    {
        // verify the required parameter 'xChronosheetsAuth' is set
        if ($xChronosheetsAuth === null || (is_array($xChronosheetsAuth) && count($xChronosheetsAuth) === 0)) {
            throw new \InvalidArgumentException(
