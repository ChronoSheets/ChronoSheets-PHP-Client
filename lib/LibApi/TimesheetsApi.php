...
class TimesheetsApi
{
     ...
     *
     * @param  \ChronoSheetsClient\ChronoSheetsClientLibModel\CSTimesheet $request A Timesheet Request object containing values for the new Timesheet to create (required)
