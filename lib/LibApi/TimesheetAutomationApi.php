...
class TimesheetAutomationApi
{
     ...
     */
    public function timesheetAutomationCreateAutomationStepRequest($xChronosheetsAuth, $request)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function timesheetAutomationGetTimesheetAutomationAuditTrailRequest($geofenceId, $nfcId, $userId, $sort, $order, $xChronosheetsAuth, $skip = null, $take = null)
    {
