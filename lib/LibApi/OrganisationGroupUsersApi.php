...
class OrganisationGroupUsersApi
{
     ...
     */
    public function organisationGroupUsersGetOrganisationGroupUsersRequest($orgGroupId, $xChronosheetsAuth)
    {
        ...
        // query params
        if (is_array($orgGroupId)) {
            $orgGroupId = ObjectSerializer::serializeCollection($orgGroupId, '', true);
        }
        if ($orgGroupId !== null) {
            $queryParams['orgGroupId'] = $orgGroupId;
        }
     ...
     */
    public function organisationGroupUsersUpdateOrganisationGroupUsers($xChronosheetsAuth, $request)
    {
        list($response) = $this->organisationGroupUsersUpdateOrganisationGroupUsersWithHttpInfo($xChronosheetsAuth, $request);
        return $response;
    }
     ...
     */
    public function organisationGroupUsersUpdateOrganisationGroupUsersWithHttpInfo($xChronosheetsAuth, $request)
    {
        $request = $this->organisationGroupUsersUpdateOrganisationGroupUsersRequest($xChronosheetsAuth, $request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function organisationGroupUsersUpdateOrganisationGroupUsersAsync($xChronosheetsAuth, $request)
    {
        return $this->organisationGroupUsersUpdateOrganisationGroupUsersAsyncWithHttpInfo($xChronosheetsAuth, $request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function organisationGroupUsersUpdateOrganisationGroupUsersAsyncWithHttpInfo($xChronosheetsAuth, $request)
    {
        $returnType = '\ChronoSheetsClient\ChronoSheetsClientLibModel\ApiResponseBoolean';
        $request = $this->organisationGroupUsersUpdateOrganisationGroupUsersRequest($xChronosheetsAuth, $request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function organisationGroupUsersUpdateOrganisationGroupUsersRequest($xChronosheetsAuth, $request)
    {
        // verify the required parameter 'xChronosheetsAuth' is set
        if ($xChronosheetsAuth === null || (is_array($xChronosheetsAuth) && count($xChronosheetsAuth) === 0)) {
            throw new \InvalidArgumentException(
