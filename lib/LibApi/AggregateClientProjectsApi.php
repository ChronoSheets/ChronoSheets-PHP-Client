...
class AggregateClientProjectsApi
{
     ...
     * @return \ChronoSheetsClient\ChronoSheetsClientLibModel\CSApiResponseListAggregateClient
     */
     ...
     * @throws \ChronoSheetsClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ChronoSheetsClient\ChronoSheetsClientLibModel\CSApiResponseListAggregateClient, HTTP status code, HTTP response headers (array of strings)
     */
    public function aggregateClientProjectsGetAggregateClientProjectsWithHttpInfo($xChronosheetsAuth)
    {
        $returnType = '\ChronoSheetsClient\ChronoSheetsClientLibModel\CSApiResponseListAggregateClient';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ChronoSheetsClient\ChronoSheetsClientLibModel\CSApiResponseListAggregateClient',
     ...
     */
    protected function aggregateClientProjectsGetAggregateClientProjectsRequest($xChronosheetsAuth)
    {
        ...
        $resourcePath = '/api/AggregateClientProjects/GetAggregateClientProjects';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
