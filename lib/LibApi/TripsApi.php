...
class TripsApi
{
     ...
     *
     * @param  \ChronoSheetsClient\ChronoSheetsClientLibModel\CSCreateTripRequest $request The create trip request (required)
     ...
     * Get trip by Id
     *
     * @param  int $tripId The ID of the trip (required)
     * @param  string $xChronosheetsAuth The ChronoSheets Auth Token (required)
     *
     * @throws \ChronoSheetsClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  int $skip skip (required)
     * @param  int $take take (required)
     * @param  int $vehicleId vehicleId (required)
     * @param  string $xChronosheetsAuth The ChronoSheets Auth Token (required)
     *
     * @throws \ChronoSheetsClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
