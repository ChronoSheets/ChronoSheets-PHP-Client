...
class OrganisationGroupsApi
{
     ...
     *
     * @param  \ChronoSheetsClient\ChronoSheetsClientLibModel\CSInsertOrganisationGroupRequest $request  (required)
     ...
     *
     * @param  int $organisationGroupId The ID of the organisation group you want to get (required)
     * @param  string $xChronosheetsAuth The ChronoSheets Auth Token (required)
     *
     * @throws \ChronoSheetsClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \ChronoSheetsClient\ChronoSheetsClientLibModel\CSSaveOrganisationGroupRequest $request  (required)
     * @param  string $xChronosheetsAuth The ChronoSheets Auth Token (required)
     *
     * @throws \ChronoSheetsClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
