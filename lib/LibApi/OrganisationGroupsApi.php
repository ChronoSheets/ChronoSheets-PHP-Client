...
class OrganisationGroupsApi
{
     ...
     */
    protected function organisationGroupsCreateOrganisationGroupRequest($xChronosheetsAuth, $request)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function organisationGroupsUpdateOrganisationGroupRequest($xChronosheetsAuth, $request)
    {
        // verify the required parameter 'xChronosheetsAuth' is set
        if ($xChronosheetsAuth === null || (is_array($xChronosheetsAuth) && count($xChronosheetsAuth) === 0)) {
            throw new \InvalidArgumentException(
