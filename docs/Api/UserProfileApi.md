...
> \ChronoSheetsClient\ChronoSheetsClientLibModel\ApiResponseDoLoginResponse userProfileDoLogin($request)
...
> \ChronoSheetsClient\ChronoSheetsClientLibModel\ApiResponseBoolean userProfileDoLogout($xChronosheetsAuth)
...
> \ChronoSheetsClient\ChronoSheetsClientLibModel\ApiResponseUserProfile userProfileGetMyProfile($xChronosheetsAuth)
...
> \ChronoSheetsClient\ChronoSheetsClientLibModel\ApiResponseBoolean userProfileKeepSessionAlive($xChronosheetsAuth)
...
> \ChronoSheetsClient\ChronoSheetsClientLibModel\ApiResponseUpdateProfileResponse userProfileUpdateMyProfile($xChronosheetsAuth, $request)
